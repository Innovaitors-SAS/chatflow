...
const FlowDiagramComponent = forwardRef(({ onYamlChange, initialData, testedPath, flowTitle, onFlowTitleChange, onFlowChange, isSidebarVisible }, ref) => {
    ...
    }, [reactFlowInstance, nodes, edges, takeSnapshot, undo, redo]);
    ...
    useEffect(() => {
        ...
        if (oldIds.size === currentSelectedNodeIds.size && [...oldIds].every(id => currentSelectedNodeIds.has(id))) {
            return;
        }
...
FlowDiagramComponent.displayName = 'FlowDiagramComponent';


const FlowDiagram = forwardRef((props, ref) => (
    <ReactFlowProvider>
        <FlowDiagramComponent {...props} ref={ref} />
    </ReactFlowProvider>
));
