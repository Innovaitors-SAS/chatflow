                ...
                <div className="help-tutorial-body">
                    ...
                    <section>
                        ...
                        <div className="button-explanation">
                             <h4><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4" /><polyline points="7 10 12 15 17 10" /><line x1="12" y1="15" x2="12" y2="3" /></svg> Descargar Flujo (.chatflow)</h4>
                             <p>Este botón empaqueta todo el flujo, incluido el diseño visual, la lógica YAML y cualquier archivo adjunto, en un único archivo <code>.chatflow</code>. Este archivo se puede compartir y volver a cargar en el constructor para seguir trabajando en él más tarde.</p>
                        </div>
                         <div className="button-explanation">
